...
/**
 * Command Class to divide two BigDecimal
 * @author Monika
 *
 */
public class DivCommand extends AbstractCommand
{
     ...
     */
    public DivCommand(BigDecimal op1, BigDecimal op2, long workMillisMin, long workMillisMax)
    {
     ...
     * @param workMillisMax max time for pause
     */
    public DivCommand(Double op1, Double op2, long workMillisMin, long workMillisMax)
    {
