...
public class DivCommandTest
{
    ...
    public void test()
    {
        ...
        double op11 = 10;
        double op22 = 5;
        AbstractCommand cmd1 = new DivCommand(op11, op22, min, max);
